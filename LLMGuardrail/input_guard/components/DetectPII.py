...
@register_validator(name="STAIR/DetectPII", data_type="string", has_guardrails_endpoint=True)
    ...
    def validate(self, value: Any, metadata: Dict[str, Any]) -> ValidationResult:
        ...
        return FailResult(
            error_message=(str({
                        ...
                        "category": 32,
                        "failure": "文本具有疑似敏感信息",
                        "refactor_content": anonymized.text,
                    })),
